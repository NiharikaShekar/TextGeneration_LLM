...
object SlidingWindow {
  def main(args: Array[String]): Unit = {
    ...
    val filePath = "/Users/niharikabelavadishekar/Documents/Cloud_Assignment/Homework2_LLM/src/main/resources/input/input.txt" // Replace with the actual file path
